...
- TypeScript-এ keyof হলো একটি keyword যা কোনো object type-এর key-এর type বের করতে ব্যবহার করা হয়। যখন এটি explicit key-এর সাথে কোনো object type-এ ব্যবহার করা হয়, তখন keyof সেই keys দিয়ে একটি union type তৈরি করে। ```ts
